...
The HTTP response is JSON for a non-streaming response, or [newline-delimited JSON]([https://ndjson.org/home/](https://database.guide/what-is-ndjson/)) ("NDJSON"/"jsonlines") for a streaming response.
